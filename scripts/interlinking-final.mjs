...
function main() {
  ...
  try {
    ...
    // Limitar a 50 archivos para prueba
    const filesToProcess = parsedFiles.slice(0, 50);
    console.log(`📝 Procesando primeros ${filesToProcess.length} archivos (prueba limitada)`);
    ...
    if (CONFIG.dryRun) {
      ...
      console.log('💡 Para procesar todos los archivos, elimina la limitación de 50 archivos en el script.');
    } else {
