...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/global-ia/disociacion-ia-agencia-legal-2026",
  },
};

export default async function PostPage() {
  const posts = getAllPosts();
  const post = posts.find(p => p.slug === "disociacion-ia-agencia-legal-2026");
      ...
      >
        ...
        <div className="mt-16 pt-8 border-t border-slate-200">
          <RelatedArticles
            ...
            currentCategory={post.frontmatter.category || "ia-global"}
          />
        </div>
      </LegalLayout>
    </>
