...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/jurisprudencia/boligportal-redata-scraping-api-bases-datos-ia-dinamarca-2025",
  },
};

export default async function PostPage() {
  const posts = getAllPosts();
  const post = posts.find(p => p.slug === "boligportal-redata-scraping-api-bases-datos-ia-dinamarca-2025");
      ...
      >
        ...
        <div className="mb-8 p-6 bg-blue-50 border border-blue-200 rounded-lg">
          <div className="flex items-center justify-between">
            ...
            <Link
              href="/fuentes/boligportal-redata-scraping-api-bases-datos-ia.pdf"
              target="_blank"
