...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/firma-scarpa/vigilancia-vertical-rpas-ia-colapso-salvaguardas",
  },
};

export default async function PostPage() {
  const posts = getAllPosts();
  const post = posts.find(p => p.slug === "vigilancia-vertical-rpas-ia-colapso-salvaguardas");
